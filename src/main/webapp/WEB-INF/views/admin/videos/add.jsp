...
<head>
    ...
    <title>Add Video - Video Portal Admin</title>
            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0"><i class="fas fa-video"></i> Add New Video</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/admin/videos/add">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" 
                                          rows="4" placeholder="Enter video description...">${param.description}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="url" class="form-label">Video URL <span class="text-danger">*</span></label>
                                <input type="url" class="form-control" id="url" name="url" 
                                       value="${param.url}" required maxlength="255">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="uploaderId" name="uploaderId" required>
                                    ...
                                    <c:forEach var="user" items="${users}">
                                        <option value="${user.userId}" ${param.uploaderId == user.userId ? 'selected' : ''}>${user.fullName} (${user.email})</option>
                                    </c:forEach>
                                </select>
                            </div>
