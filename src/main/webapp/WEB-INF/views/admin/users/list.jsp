...
<head>
    ...
    <title>Users - Video Portal Admin</title>
...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="get" action="${pageContext.request.contextPath}/admin/users/list">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-list"></i> Users List <span class="badge bg-secondary ms-2">${users.size()}</span></h5>
            </div>
            <div class="card-body">
                <c:choose>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/admin/users/delete?id=${user.userId}" 
