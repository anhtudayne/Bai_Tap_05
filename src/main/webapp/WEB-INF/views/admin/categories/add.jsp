...
<head>
    ...
    <title>Add Category - Video Portal Admin</title>
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/admin/categories/add">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="categoryName" name="categoryName" 
                                       value="${param.categoryName}" required maxlength="100">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" 
                                          rows="4" placeholder="Enter category description...">${param.description}</textarea>
